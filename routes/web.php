...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            // Patients
            Route::get('patients', 'Tenant\PatientController@index')->name('tenant.patients.index');
            Route::get('patients/create', 'Tenant\PatientController@create')->name('tenant.patients.create');
            Route::get('patients/tables', 'Tenant\PatientController@tables');
            Route::get('patients/record/{patient}', 'Tenant\PatientController@record');
            Route::get('patients/document/{document_number}', 'Tenant\PatientController@recordByDocumentNumber');
            Route::post('patients', 'Tenant\PatientController@store');
            Route::get('patients/records', 'Tenant\PatientController@records');
            Route::delete('patients/{patient}', 'Tenant\PatientController@destroy');

            // Doctors
            Route::get('doctors', 'Tenant\DoctorController@index')->name('tenant.doctors.index');
            Route::get('doctors/create', 'Tenant\DoctorController@create')->name('tenant.doctors.create');
            Route::get('doctors/tables', 'Tenant\DoctorController@tables');
            Route::get('doctors/record/{doctor}', 'Tenant\DoctorController@record');
            Route::post('doctors', 'Tenant\DoctorController@store');
            Route::get('doctors/records', 'Tenant\DoctorController@records');
            Route::delete('doctors/{doctor}', 'Tenant\DoctorController@destroy');

            // Medical Professionals
            Route::get('medical_professionals', 'Tenant\MedicalProfessionalController@index')->name('tenant.medical_professionals.index');
            Route::get('medical_professionals/create', 'Tenant\MedicalProfessionalController@create')->name('tenant.medical_professionals.create');
            Route::get('medical_professionals/tables', 'Tenant\MedicalProfessionalController@tables');
            Route::get('medical_professionals/record/{medical_professional}', 'Tenant\MedicalProfessionalController@record');
            Route::post('medical_professionals', 'Tenant\MedicalProfessionalController@store');
            Route::get('medical_professionals/records', 'Tenant\MedicalProfessionalController@records');
            Route::delete('medical_professionals/{medical_professional}', 'Tenant\MedicalProfessionalController@destroy');
            Route::post('medical_professionals/check_status', 'Tenant\MedicalProfessionalController@checkStatus');

            // Medical Services
            Route::get('medical_services', 'Tenant\MedicalServiceController@index')->name('tenant.medical_services.index');
            Route::get('medical_services/create', 'Tenant\MedicalServiceController@create')->name('tenant.medical_services.create');
            Route::get('medical_services/tables', 'Tenant\MedicalServiceController@tables');
            Route::get('medical_services/record/{medical_service}', 'Tenant\MedicalServiceController@record');
            Route::post('medical_services', 'Tenant\MedicalServiceController@store');
            Route::get('medical_services/records', 'Tenant\MedicalServiceController@records');
            Route::delete('medical_services/{medical_service}', 'Tenant\MedicalServiceController@destroy');
            Route::post('medical_services/check_status', 'Tenant\MedicalServiceController@checkStatus');

            // Appointments
            Route::get('appointments', 'Tenant\AppointmentController@index')->name('tenant.appointments.index');
            Route::get('appointments/create', 'Tenant\AppointmentController@create')->name('tenant.appointments.create');
            Route::get('appointments/tables', 'Tenant\AppointmentController@tables');
            Route::get('appointments/tables', 'Tenant\AppointmentController@tables');
            Route::get('appointments/record/{appointment}', 'Tenant\AppointmentController@record');
            Route::post('appointments', 'Tenant\AppointmentController@store');
            Route::get('appointments/edit/{id}', 'Tenant\AppointmentController@edit');
            Route::get('appointments/data_edit/{id}', 'Tenant\AppointmentController@dataEdit');
            Route::get('appointments/professionals/data_edit/{id}', 'Tenant\AppointmentController@professionalDataEdit');
            Route::post('appointments/validate_patient', 'Tenant\AppointmentController@validatePatientAppointment');
            Route::post('appointments/validate_professional', 'Tenant\AppointmentController@validateProfessionalAppointment');
            Route::get('appointments/records', 'Tenant\AppointmentController@records');
            Route::delete('appointments/{appointment}', 'Tenant\AppointmentController@destroy');
            Route::get('appointments/list_speciality/{speciality}', 'Tenant\AppointmentController@professionalsBySpeciality');
            Route::post('appointments/update_patient', 'Tenant\AppointmentController@updatePatientAppointment');
            Route::post('appointments/update_professional', 'Tenant\AppointmentController@updateProfessionalAppointment');

            // Medical Departments
            Route::get('medical_departments', 'Tenant\MedicalDepartmentController@index')->name('tenant.medical_departments.index');
            Route::get('medical_departments/create', 'Tenant\MedicalDepartmentController@create')->name('tenant.medical_departments.create');
            Route::get('medical_departments/tables', 'Tenant\MedicalDepartmentController@tables');
            Route::get('medical_departments/record/{medical_department}', 'Tenant\MedicalDepartmentController@record');
            Route::post('medical_departments', 'Tenant\MedicalDepartmentController@store');
            Route::get('medical_departments/records', 'Tenant\MedicalDepartmentController@records');
            Route::delete('medical_departments/{medical_department}', 'Tenant\MedicalDepartmentController@destroy');
            Route::post('medical_departments/check_status', 'Tenant\MedicalDepartmentController@checkStatus');
