                ...
                <ul class="nav nav-main">
                    ...
                    @if(in_array('clinic', $vc_modules))
                        <li class="nav-parent {{ in_array($path[0],
                            ['clinic', 'patients', 'doctors', 'medical_professionals', 'medical_services', 'appointments', 'medical_departments'])?'nav-active nav-expanded':'' }}">
                            <a class="nav-link" href="#">
                                <span class="float-right badge badge-red badge-danger mr-3">Nuevo</span>
                                <i class="fas fa-clinic-medical" aria-hidden="true"></i>
                                <span>Atencion Médica</span>
                            </a>

                            <ul class="nav nav-children">
                                <li class="{{ ($path[0] === 'appointments')?'nav-active':'' }}">
                                    <a class="nav-link" href="{{route('tenant.appointments.index')}}">
                                        Citas
                                    </a>
                                </li>
                                <li class="{{ ($path[0] === 'patients')?'nav-active':'' }}">
                                    <a class="nav-link" href="{{route('tenant.patients.index')}}">
                                        Pacientes
                                    </a>
                                </li>
                                <li class="{{ ($path[0] === 'doctors')?'nav-active':'' }}">
                                    <a class="nav-link" href="{{route('tenant.doctors.index')}}">
                                        Doctores
                                    </a>
                                </li>
                                <li class="{{ ($path[0] === 'medical_professionals')?'nav-active':'' }}">
                                    <a class="nav-link" href="{{route('tenant.medical_professionals.index')}}">
                                        Profesionales Médicos
                                    </a>
                                </li>
                                <li class="{{ ($path[0] === 'medical_services')?'nav-active':'' }}">
                                    <a class="nav-link" href="{{route('tenant.medical_services.index')}}">
                                        Servicios Médicos
                                    </a>
                                </li>
                                <li class="{{ ($path[0] === 'medical_departments')?'nav-active':'' }}">
                                    <a class="nav-link" href="{{route('tenant.medical_departments.index')}}">
                    ...
                    @if(in_array('ecommerce', $vc_modules))
                        <li class="nav-parent {{ in_array($path[0], ['ecommerce','items_ecommerce', 'tags', 'promotions', 'orders', 'configuration'])?'nav-active nav-expanded':'' }}">
                            ...
                            <ul class="nav nav-children">
                                <li class="">
                                    <a class="nav-link"
                                       onclick="window.open( '{{ route("tenant.ecommerce.index") }} ')">
                                        Ir a Tienda
                                    </a>
                                </li>
                                ...
                                {{ ($path[0] === 'dispatchers')?'nav-active nav-expanded':'' }}
                                    ...
                                    <ul class="nav nav-children">
                                        ...
                                        <li class="{{ ($path[0] === 'dispatchers')?'nav-active':'' }}">
                                            <a class="nav-link"
                                               href="{{route('tenant.order_forms.dispatchers.index')}}">
                                                Transportistas
                                            </a>
                                        </li>
                            ...
                            <ul class="nav nav-children" style="">
                                ...
                                <li class="nav-parent {{  ($path[0] === 'reports' &&
                                    ...
                                    <ul class="nav nav-children">
                                        ...
                                        <li class="{{(($path[0] === 'reports') && ($path[1] === 'fixed-asset-purchases')) ? 'nav-active' : ''}}">
                                            <a class="nav-link"
                                               href="{{route('tenant.reports.fixed-asset-purchases.index')}}">
                                                Activos fijos
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="nav nav-children">
                                        ...
                                        @if($vc_company->soap_type_id != '03')
                                            <li class="{{(($path[0] === 'reports') && ($path[1] == 'document-detractions')) ? 'nav-active' : ''}}">
                                                <a class="nav-link"
                                                   href="{{route('tenant.reports.document_detractions.index')}}">
                                                    Detracciones
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        {{ (($path[0] === 'reports') && ($path[1] == 'user-commissions')) ?'nav-active nav-expanded':'' }}
                                            ...
                                            <ul class="nav nav-children">
                                                ...
                                                <li class="{{(($path[0] === 'reports') && ($path[1] == 'user-commissions')) ? 'nav-active' : ''}}">
                                                    <a class="nav-link"
                                                       href="{{route('tenant.reports.user_commissions.index')}}">
                                                        Utilidad ventas
                                                    </a>
                                                </li>
                                                ...
                                                <li class="{{(($path[0] === 'reports') && ($path[1] == 'commissions')) ? 'nav-active' : ''}}">
                                                    <a class="nav-link"
                                                       href="{{route('tenant.reports.commissions.index')}}">
                                                        Ventas
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="{{(($path[0] === 'reports') && ($path[1] == 'sales-consolidated')) ? 'nav-active' : ''}}">
                                            <a class="nav-link"
                                               href="{{route('tenant.reports.sales_consolidated.index')}}">
                                ...
                                <li class="nav-parent {{  ($path[0] === 'reports' &&
                                    ...
                                    <ul class="nav nav-children">
                                        ...
                                        <li class="{{(($path[0] === 'reports') && ($path[1] == 'order-notes-general')) ? 'nav-active' : ''}}">
                                            <a class="nav-link"
                                               href="{{route('tenant.reports.order_notes_general.index')}}">
                                                General
                                            </a>
                                        </li>
                                        ...
                                        <li class="{{(($path[0] === 'reports') && ($path[1] == 'order-notes-consolidated')) ? 'nav-active' : ''}}">
                                            <a class="nav-link"
                                               href="{{route('tenant.reports.order_notes_consolidated.index')}}">
                                                Consolidado de items
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                @if($vc_company->soap_type_id != '03')
                                    <li class="{{(($path[0] === 'reports') && ($path[1] == 'consistency-documents')) ? 'nav-active' : ''}}">
                                        <a class="nav-link" href="{{route('tenant.consistency-documents.index')}}">Consistencia
                                            documentos</a>
                                    </li>
                            ...
                            <ul class="nav nav-children" style="">
                                ...
                                @if(auth()->user()->type != 'integrator' && $vc_company->soap_type_id != '03')
                                    <li class="{{($path[0] === 'tasks') ? 'nav-active': ''}}">
                                        <a class="nav-link" href="{{route('tenant.tasks.index')}}">Tareas
                                            programadas</a>
                                    </li>
