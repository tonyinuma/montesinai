...
Vue.component('tenant-items-expire', require('./views/tenant/items/expire/index'));
...
Vue.component('tenant-patients-index', require('./views/tenant/patients/index.vue'));
Vue.component('tenant-doctors-index', require('./views/tenant/doctors/index.vue'));
Vue.component('tenant-medical_professionals-index', require('./views/tenant/medical_professionals/index.vue'));
Vue.component('tenant-medical_services-index', require('./views/tenant/medical_services/index.vue'));
Vue.component('tenant-appointments-index', require('./views/tenant/appointments/index.vue'));
Vue.component('tenant-medical_departments-index', require('./views/tenant/medical_departments/index.vue'));
...
Vue.component('x-input-patient-service', require('./components/InputPatientService.vue'));
