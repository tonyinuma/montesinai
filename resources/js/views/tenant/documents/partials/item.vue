        ...
        <form autocomplete="off" @submit.prevent="clickAddItem">
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-3" v-show="form.item_type_id === '01'">
                        <div class="form-group" :class="{'has-danger': errors.date_of_due}">
                            <label class="control-label">Fec. Vencimiento Producto</label>
    ...
    export default {
        ...
        methods: {
            ...
            async changeItem() {
                ...
                this.form.date_of_due = this.form.item.date_of_due;
                this.form.item_type_id = this.form.item.item_type_id;
