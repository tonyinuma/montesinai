                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.second_name}">
                            <label class="control-label">Nombre secundario (Nombre genérico)</label>
                            <el-input v-model="form.second_name" dusk="second_name"></el-input>
                            <small class="form-control-feedback" v-if="errors.second_name"
                    ...
                    <div class="col-md-2">
                        <div class="form-group" :class="{'has-danger': errors.sale_unit_price}">
                            <label class="control-label">Precio Unitario (Venta) <span
                    ...
                    <div class="col-md-4">
                        <div class="form-group" :class="{'has-danger': errors.item_type_id}">
                            <label class="control-label">
                                Tipo de Item/Artículo
                            </label>
                            <el-select v-model="form.item_type_id" filterable
                                       clearable>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.category_id}">
                            ...
                            <a href="#" v-if="form_category.add == false"
                               class="control-label font-weight-bold text-info" @click="form_category.add = true"> [ +
                                Nuevo]</a>
                            <a href="#" v-if="form_category.add == true"
                               class="control-label font-weight-bold text-info" @click="saveCategory()"> [ +
                                Guardar]</a>
                            <a href="#" v-if="form_category.add == true"
                               class="control-label font-weight-bold text-danger" @click="form_category.add = false"> [
                                Cancelar]</a>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.brand_id}">
                            ...
                            <a href="#" v-if="form_brand.add == false" class="control-label font-weight-bold text-info"
                               @click="form_brand.add = true"> [ + Nuevo]</a>
                            <a href="#" v-if="form_brand.add == true" class="control-label font-weight-bold text-info"
                               @click="saveBrand()"> [ + Guardar]</a>
                            <a href="#" v-if="form_brand.add == true" class="control-label font-weight-bold text-danger"
                            ...
                            <small class="form-control-feedback" v-if="errors.brand_id"
                    ...
                    <div v-show="form.unit_type_id !='ZZ'" class="col-md-3 center-el-checkbox">
                        <div class="form-group" :class="{'has-danger': errors.calculate_quantity}">
                            ...
                            <br>
                            <small class="form-control-feedback" v-if="errors.calculate_quantity"
                    ...
                    <div class="col-md-3 center-el-checkbox" v-show="show_has_igv">
                        <div class="form-group" :class="{'has-danger': errors.has_igv}">
                            <el-checkbox v-model="form.has_igv">Incluye Igv {{ configuration.include_igv }}
                            </el-checkbox>
                            <br>
                            <small class="form-control-feedback" v-if="errors.has_igv"
                    ...
                    <div class="col-md-3" v-show="form.unit_type_id !='ZZ' && form.series_enabled && !recordId">
                        <div class="form-group" :class="{'has-danger': errors.lot_code}">
                            ...
                            <el-button style="margin-top:2%;" type="primary" icon="el-icon-edit-outline"
                    ...
                    <div class="col-md-3 center-el-checkbox">
                        <div class="form-group">
                            <el-checkbox v-model="form.has_perception" @change="changeHasPerception">Incluye
                                percepción
                            </el-checkbox>
                            <br>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">
                                        Factor
                                        <el-tooltip class="item" effect="dark" content="Cantidad de unidades"
                                                    placement="top">
                                            <i class="fa fa-info-circle"></i>
                                        </el-tooltip>
                                    </th>
                    ...
                    <div v-if="attribute_types.length > 0" class="col-md-12">
                        <h5 class="separator-title ">
                            Atributos
                            <el-tooltip class="item" effect="dark"
                                        content="Diferentes presentaciones para la venta del producto" placement="top">
                                <i class="fa fa-info-circle"></i>
                            </el-tooltip>
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="short-div col-md-8">
                                    <div class="form-group"
                                         :class="{'has-danger': errors.purchase_affectation_igv_type_id}">
                                    ...
                                    <div class="form-group" :class="{'has-danger': errors.percentage_of_profit}">
                                        <label class="control-label">
                                            <el-checkbox v-model="enabled_percentage_of_profit"
                                                         @change="changeEnabledPercentageOfProfit"></el-checkbox>
                                        ...
                                        <small class="form-control-feedback" v-if="errors.percentage_of_profit"
                                ...
                                <div class="short-div col-md-4 center-el-checkbox" v-show="purchase_show_has_igv">
                                    <div class="form-group" :class="{'has-danger': errors.purchase_has_igv}">
                                        <el-checkbox v-model="form.purchase_has_igv">Incluye Igv (Compra)</el-checkbox>
                                        <br>
                                        <small class="form-control-feedback" v-if="errors.purchase_has_igv"
...
export default {
    ...
    methods: {
        ...
        create() {
            this.titleDialog = (this.recordId) ? 'Editar Producto/Servicio' : 'Nuevo Producto/Servicio'
            if (this.recordId) {
