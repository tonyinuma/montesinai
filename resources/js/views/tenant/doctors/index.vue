    ...
    <div>
        <div class="page-header pr-0">
            ...
            <ol class="breadcrumbs">
                <li class="active"><span>Doctores</span></li>
            </ol>
        ...
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="my-0">Listado de Doctores</h3>
            </div>
            <div class="card-body">
            ...
            <doctors-form :showDialog.sync="showDialog"
                        :typeUser="typeUser"
                        :recordId="recordId"></doctors-form>
        </div>
    </div>
</template>
...
<script>
    ...
    import DoctorsForm from './form1.vue'
    import {deletable} from '../../../mixins/deletable'

    export default {
        props: ['typeUser'],
        mixins: [deletable],
        components: {DoctorsForm},
        data() {
            return {
                showDialog: false,
                resource: 'doctors',
