<template>
    <div class="card mb-0 pt-2 pt-md-0">
            ...
            <div class="invoice">
                ...
                <form autocomplete="off" @submit.prevent="submit">
                    <div class="form-body">
                        ...
                        <div class="col-lg-8 mt-2">
                            <a href="#" @click.prevent="clickAddPatient" class="text-center font-weight-bold text-info">[+
                                Agregar Cita/Paciente]</a>
                        </div>
                        <div class="col-lg-8 mt-2">
                            <a href="#" @click.prevent="clickAddProfessional" class="text-center font-weight-bold text-info">[+
                                Agregar Personal Médico]</a>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
        ...
        <patients-form
            :showDialog.sync="showDialogFormPatient"
            :patient="form.patient"
            @addPatient="addPatient"></patients-form>

        <professionals-form
            :showDialog.sync="showDialogFormProfessional"
            :professional="form.professional"
            @addProfessional="addProfessional"></professionals-form>
...
export default {
    ...
    components: {QuotationFormItem, PersonForm, QuotationOptions, Logo, TermsCondition, PatientsForm, ProfessionalsForm},
    ...
    data() {
        return {
            ...
            showDialogFormPatient: false,
            showDialogFormProfessional: false,
    ...
    methods: {
        ...
        clickAddPatient() {
            this.showDialogFormPatient = true
        },
        clickAddProfessional() {
            this.showDialogFormProfessional = true
        },
        addPatient(patient) {
