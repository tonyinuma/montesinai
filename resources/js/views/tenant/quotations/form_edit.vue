<template>
    <div class="card mb-0 pt-2 pt-md-0">
            ...
            <div class="invoice">
                ...
                <form autocomplete="off" @submit.prevent="submit">
                    <div class="form-body">
                        ...
                        <div class="col-lg-8 mt-2">
                            <a href="#" @click.prevent="showDialogEditPatient = true"
                               class="text-center font-weight-bold text-info">[<i class="fa fa-pen"></i>
                                Editar Cita/Paciente]</a>
                        </div>
                        <div class="col-lg-8 mt-2">
                            <a href="#" @click.prevent="showDialogEditProfessional = true"
                               class="text-center font-weight-bold text-info">[ <i class="fa fa-pen"></i>
                                Editar Personal Seleccionado]</a>
                        </div>
                        <div class="row mt-2">
                            <div class="col-md-12">
        ...
        <patient-edit-form
            ...
            :showDialog.sync="showDialogEditPatient">
        </patient-edit-form>

        <professional-edit-form
            :recordId="this.resourceId"
            :showDialog.sync="showDialogEditProfessional">
        </professional-edit-form>
...
import PatientEditForm from './patients/form_edit'
import ProfessionalEditForm from './professionals/form_edit'

export default {
    components: {QuotationFormItem, PersonForm, QuotationOptions, Logo, TermsCondition, PatientEditForm, ProfessionalEditForm},
    props: {
        'resourceId': {
            required: true,
            default: 0
    ...
    data() {
        return {
            ...
            showDialogEditPatient: false,
            showDialogEditProfessional: false,
